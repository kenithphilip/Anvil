...
const SYSTEM_PROMPT = [
  ...
  "  - A small distributor (e.g. 'Summit Automation Pvt Ltd') buys OBARA-brand spares for use at a",
  "    Meridian Steel customer site. The customer is the distributor, not OBARA, not Meridian.",
