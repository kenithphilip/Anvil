...
export const SYSTEM_PROMPT = [
  ...
  "  - lines[].partNumber OUR part / SKU code for the line. CRITICAL: the part number is NOT always in a",
  ...
  "                       This is the buyer's code, DISTINCT from OUR partNumber. Capture BOTH when both are",
  "                       printed on the line; null when the PO prints no such column.",
  ...
  "still return exactly one lines[] entry per printed S.No / Line / Item, with customerItemCode + raw_description set.",
  "",
