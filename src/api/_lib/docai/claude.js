...
const SYSTEM_PROMPT = [
  ...
  "    (e.g. 'OBARA spot welding gun', 'SKF bearings', 'Schneider VFD' -- the buyer is the purchaser",
  ...
  "  - A small distributor (e.g. 'Faith Automation Pvt Ltd') buys OBARA-brand spares for use at a",
  "    Hyundai Steel customer site. The customer is the distributor, not OBARA, not Hyundai.",
  "  - A Tier-2 supplier buys SKF bearings to assemble into a Tata Motors line. The customer is the",
  ...
  "",
  "  Per-unit tax + auxiliary components. The Hyundai-style PO layout prints each as its own column",
  ...
  "Many Indian and Korean OEM POs (HMIL / Hyundai Motor India, Hyundai Steel, KIA, Tata Motors, MG Motor,",
  "JBM Auto) print each line item across multiple physical rows. A typical 4 or 5-row block looks like:",
  ...
  "",
  "When you encounter an HMIL-style PO (header 'HYUNDAI MOTOR INDIA LTD', vendor_code labelled 'TH...'),",
      ...
      lines: {
        ...
        items: {
          ...
          properties: {
            ...
            // Per-unit tax components. The Hyundai-style PO prints
