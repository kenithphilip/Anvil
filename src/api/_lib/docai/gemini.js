...
const PO_SYSTEM_PROMPT = [
  ...
  "The customer is NOT the end-customer / project owner ('for Hyundai Steel Project HDS-1234'),",
  "NOT the equipment brand / OEM referenced in line-item descriptions or part codes (OBARA welding gun,",
  ...
  "  Faith Automation Pvt Ltd buys OBARA-brand spares for a Hyundai customer site -> customer is Faith Automation.",
  ...
  "Customer fields: name, email, phone, po_number, po_date, country, gstin, state_code, tax_id,",
  "tax_id_type, currency, payment_terms, bill_to_address, ship_to_address.",
  "",
  ...
  "",
  "Each line: partNumber, description, quantity, unitPrice, uom, hsn (4-8 digits, IN only), gst_pct (IN only).",
  "",
