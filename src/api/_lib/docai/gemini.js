...
const PO_SYSTEM_PROMPT = [
  ...
  "",
  "Each line: partNumber, description, specification (per-tenant drawing/spec code if printed separately),",
  ...
  "",
  "Per-unit tax + auxiliary fields. Indian POs (especially Hyundai-style) print these as separate columns;",
