...
import { Card, WSTitle, Btn } from "./primitives";
import { Icon } from "./icons";

export interface PlaceholderProps { name: string; legacyHash?: string; }

export const Placeholder: React.FC<PlaceholderProps> = ({ name, legacyHash }) => (
...
export const placeholderFor = (name: string): React.FC => () => <Placeholder name={name} />;
