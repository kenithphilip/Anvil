...
export const ROLES = ["sales_engineer", "sales_manager", "procurement", "finance", "admin", "operator", "viewer"];
...
export const canRead = (navId) => /[rwax]/.test(cell(navId));
export const canWrite = (navId) => /[wa]/.test(cell(navId));
export const canApprove = (navId) => /[a]/.test(cell(navId));
export const isAdmin = () => /[x]/.test(cell("admin")) || /[x]/.test(cell("security"));
...
export const filterNav = (NAV) => NAV.map((g) => ({
  ...g,
