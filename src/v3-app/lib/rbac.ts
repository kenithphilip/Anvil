...
export const MATRIX: Record<string, MatrixRow> = {
  ...
  "sales-ops": { sales_engineer: "r",   sales_manager: "r",  procurement: "r",  finance: "r",   admin: "r",  operator: "",   viewer: "r" },
  ...
  logistics:              { sales_engineer: "r",  sales_manager: "r",   procurement: "rwa", finance: "r",    admin: "rwa", operator: "r",  viewer: "r" },
