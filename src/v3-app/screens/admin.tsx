...
import {
  ItemFieldsPanel, DocumentTemplatesPanel, FreightRatesPanel, PricingSettingsPanel,
  VendorCodesPanel, CustomerPartsPanel, CustomerTermsPanel,
} from "../components/AdminDataPanels";
import { LlmProviderCard, DocaiProvidersPanel, DocAICostPanel } from "../components/AdminLlmDocaiPanels";
...
// adminCrudFetch + parseCSV moved to ../lib/admin-shared (imported above).
