...
begin
  ...
  values
    (uuid_generate_v5('d7a7e5e4-0001-0001-0001-000000000001','slt:obara-korea:welding'),
     default_tenant, 'Northwind Korea', 'KR', 'welding_equipment', 14,
    ...
    (uuid_generate_v5('d7a7e5e4-0001-0001-0001-000000000001','slt:obara-japan:welding'),
     default_tenant, 'Northwind Japan', 'JP', 'welding_equipment', 21,
    ...
    (uuid_generate_v5('d7a7e5e4-0001-0001-0001-000000000001','slt:obara-china:assemblies'),
     default_tenant, 'Northwind China', 'CN', 'assemblies', 28,
...
begin
  ...
  values
    ...
    (uuid_generate_v5('d7a7e5e4-0001-0001-0001-000000000001','emrule:ack'),
     default_tenant, 'Acknowledg|ACK', '%@northwind%', 'pos@', 'supplier_ack',
     'Supplier acks come from internal Northwind mailboxes.', now() - interval '60 days'),
