...
insert into vendors (id, tenant_id, vendor_name, vendor_key, contact_email, contact_phone, payment_terms, default_lead_time_days, active, notes, external_ref, created_at, updated_at) values
  (uuid_generate_v5('d7a7e5e4-0001-0002-0001-000000000001','vendor:1'), '00000000-0000-0000-0000-000000000001'::uuid, 'Obara Korea Co. Ltd.',         'OKR',   'sales@obara-kr.example',   '+82 31 5550 0100', 'Advance T/T 100%',    14, true, 'Sister-company, KR factory.',         jsonb_build_object('country','KR','seed_marker','anvil-test-seed-v1'), now() - interval '720 days', now() - interval '30 days'),
  (uuid_generate_v5('d7a7e5e4-0001-0002-0001-000000000001','vendor:2'), '00000000-0000-0000-0000-000000000001'::uuid, 'Obara Japan Co. Ltd.',         'OJP',   'eigyou@obara-jp.example',  '+81 3 5550 0200',  'Advance T/T 100%',    21, true, 'Sister-company, JP factory.',         jsonb_build_object('country','JP','seed_marker','anvil-test-seed-v1'), now() - interval '720 days', now() - interval '30 days'),
  (uuid_generate_v5('d7a7e5e4-0001-0002-0001-000000000001','vendor:3'), '00000000-0000-0000-0000-000000000001'::uuid, 'Obara China Co. Ltd.',         'OCN',   'sales@obara-cn.example',   '+86 21 5550 0300', 'L/C at sight',        28, true, 'Sister-company, CN factory.',         jsonb_build_object('country','CN','seed_marker','anvil-test-seed-v1'), now() - interval '720 days', now() - interval '30 days'),
