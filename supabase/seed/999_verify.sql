...
with probes(screen, qty_min, query) as (values
  ('admin/access-requests',          1, 'select count(*) as c fromtenant_members where status = ''pending'''),
  ('admin/members',                  6, 'select count(*) as c fromtenant_members where status = ''approved'''),
  ('admin/security/audit',           1, 'select count(*) as c fromuser_security_audit'),
  ('admin/mcp-tokens',               1, 'select count(*) as c frommcp_tokens where revoked_at is null and (expires_at is null or expires_at > now())'),
  ('admin/access-reviews',           1, 'select count(*) as c fromaccess_reviews'),
  ('admin/notifications',            1, 'select count(*) as c fromadmin_notifications where resolved = false'),
  ('admin/redaction',                1, 'select count(*) as c fromredaction_rules'),
  ('admin/holiday-calendar',         1, 'select count(*) as c fromholiday_calendar'),
  ('admin/lead-times',               1, 'select count(*) as c fromsupplier_lead_times'),
  ('admin/fx',                       1, 'select count(*) as c fromfx_rates'),
  ('admin/lost-reasons',             1, 'select count(*) as c fromlost_reason_taxonomy'),
  ('admin/incoterms',                1, 'select count(*) as c frominco_terms_taxonomy'),
  ('customers',                      6, 'select count(*) as c fromcustomers'),
  ('customer-locations',             1, 'select count(*) as c fromcustomer_locations'),
  ('items',                          1, 'select count(*) as c fromitem_master'),
  ('items/aliases',                  1, 'select count(*) as c frompart_aliases'),
  ('items/uom',                      1, 'select count(*) as c fromuom_aliases'),
  ('items/bom',                      1, 'select count(*) as c frombill_of_materials'),
  ('catalog/synonyms',               1, 'select count(*) as c fromcatalog_synonyms'),
  ('catalog/alternatives',           1, 'select count(*) as c fromcatalog_alternatives'),
  ('catalog/private-label',          1, 'select count(*) as c fromprivate_label_items'),
  ('vendors',                        1, 'select count(*) as c fromvendors'),
  ('contracts',                      1, 'select count(*) as c fromcontracts'),
  ('engineering-specs',              1, 'select count(*) as c fromengineering_specs'),
  ('equipment',                      1, 'select count(*) as c fromequipment_hierarchy'),
  ('installed-base',                 1, 'select count(*) as c frominstalled_base'),
  ('leads',                          1, 'select count(*) as c fromleads'),
  ('opportunities',                  1, 'select count(*) as c fromopportunities'),
  ('projects',                       1, 'select count(*) as c fromprojects'),
  ('internal-sos',                   1, 'select count(*) as c frominternal_sales_orders'),
  ('orders',                         1, 'select count(*) as c fromorders'),
  ('orders/documents',               1, 'select count(*) as c fromorder_documents'),
  ('orders/evidence',                1, 'select count(*) as c fromevidence'),
  ('orders/findings',                1, 'select count(*) as c fromvalidation_findings'),
  ('orders/amendments',              1, 'select count(*) as c fromorder_amendments'),
  ('orders/reconciliations',         1, 'select count(*) as c fromorder_reconciliations'),
  ('orders/schedule-lines',          1, 'select count(*) as c fromorder_schedule_lines'),
  ('source-pos',                     1, 'select count(*) as c fromsource_pos'),
  ('source-pos/events',              1, 'select count(*) as c fromsource_po_events'),
  ('supplier-rfqs',                  1, 'select count(*) as c fromsupplier_rfqs'),
  ('supplier-quotes',                1, 'select count(*) as c fromsupplier_quotes'),
  ('supplier-scorecards',            1, 'select count(*) as c fromsupplier_scorecards'),
  ('shipments',                      1, 'select count(*) as c fromshipments'),
  ('approvals',                      1, 'select count(*) as c fromquote_approvals'),
  ('service/visits',                 1, 'select count(*) as c fromservice_visits'),
  ('service/amc',                    1, 'select count(*) as c fromamc_schedules'),
  ('service/car',                    1, 'select count(*) as c fromcar_reports'),
  ('service/closure',                1, 'select count(*) as c fromclosure_reports'),
  ('spares',                         1, 'select count(*) as c fromspare_recommendations'),
  ('spares/obsolete',                1, 'select count(*) as c fromobsolete_parts'),
  ('finance/invoices',               1, 'select count(*) as c frominvoices'),
  ('finance/einvoices',              1, 'select count(*) as c fromeinvoices'),
  ('finance/payments',               1, 'select count(*) as c frompayment_records'),
  ('finance/ap',                     1, 'select count(*) as c fromap_invoices'),
  ('finance/ap/lines',               1, 'select count(*) as c fromap_invoice_lines'),
  ('finance/ap/receipts',            1, 'select count(*) as c fromap_goods_receipts'),
  ('finance/deductions',             1, 'select count(*) as c fromdeduction_queue'),
  ('finance/razorpay',               1, 'select count(*) as c fromrazorpay_payments'),
  ('comms/email',                    1, 'select count(*) as c frominbound_emails'),
  ('comms/email/threads',            1, 'select count(*) as c frominbound_email_threads'),
  ('comms/chat',                     1, 'select count(*) as c frominbound_messages'),
  ('comms/voice',                    1, 'select count(*) as c fromvoice_calls'),
  ('comms/communications',           1, 'select count(*) as c fromcommunications'),
  ('esign/envelopes',                1, 'select count(*) as c fromesignature_envelopes'),
  ('esign/events',                   1, 'select count(*) as c fromesignature_events'),
  ('portal/tokens',                  1, 'select count(*) as c fromportal_tokens'),
  ('portal/access-log',              1, 'select count(*) as c fromportal_access_log'),
  ('portal/quote-acceptances',       1, 'select count(*) as c fromportal_quote_acceptances'),
  ('portal/reorders',                1, 'select count(*) as c fromportal_reorders'),
  ('agents/goals',                   1, 'select count(*) as c fromagent_goals'),
  ('agents/steps',                   1, 'select count(*) as c fromagent_steps'),
  ('agents/eval-runs',               1, 'select count(*) as c fromagent_eval_runs'),
  ('eval/cases',                     1, 'select count(*) as c fromeval_cases'),
  ('eval/runs',                      1, 'select count(*) as c fromeval_runs'),
  ('eval/case-results',              1, 'select count(*) as c fromeval_case_results'),
  ('audit/events',                   250, 'select count(*) as c fromaudit_events'),
  ('audit/export-runs',              1, 'select count(*) as c fromaudit_export_runs'),
  ('audit/processing',               1, 'select count(*) as c fromprocessing_events'),
  ('audit/injection-tests',          1, 'select count(*) as c frominjection_test_runs'),
  ('audit/model-routing',            1, 'select count(*) as c frommodel_routing_log'),
  ('audit/deploys',                  1, 'select count(*) as c fromdeploys'),
  ('audit/backups',                  1, 'select count(*) as c frombackups'),
  ('analytics/forecast',             1, 'select count(*) as c fromforecast_snapshots'),
  ('analytics/customer-monthly',     1, 'select count(*) as c fromanalytics_customer_monthly'),
  ('analytics/winloss-daily',        1, 'select count(*) as c fromanalytics_winloss_daily'),
  ('analytics/rlhf',                 1, 'select count(*) as c fromrlhf_feedback'),
  ('analytics/rlhf-reward',          1, 'select count(*) as c fromrlhf_reward_daily'),
  ('push/subscriptions',             1, 'select count(*) as c frompush_subscriptions'),
  ('push/notifications',             1, 'select count(*) as c frompush_notifications'),
  ('network/listings',               1, 'select count(*) as c fromnetwork_listings'),
  ('network/sourcing-queries',       1, 'select count(*) as c fromnetwork_sourcing_queries'),
  ('prospecting/campaigns',          1, 'select count(*) as c fromprospecting_campaigns'),
  ('prospecting/targets',            1, 'select count(*) as c fromprospecting_targets'),
  ('prospecting/suppressions',       1, 'select count(*) as c fromprospecting_suppressions'),
  ('edi/partners',                   1, 'select count(*) as c fromedi_partners'),
  ('edi/envelopes',                  1, 'select count(*) as c fromedi_envelopes'),
  ('plm/systems',                    1, 'select count(*) as c fromplm_systems'),
  ('plm/boms',                       1, 'select count(*) as c fromplm_boms'),
  ('plm/changes',                    1, 'select count(*) as c fromplm_changes'),
  ('plm/sync-state',                 1, 'select count(*) as c fromplm_sync_state'),
  ('vertical-packs',                 1, 'select count(*) as c fromvertical_pack_installs'),
  ('erp-chat/sessions',              1, 'select count(*) as c fromerp_chat_sessions'),
  ('erp-chat/messages',              1, 'select count(*) as c fromerp_chat_messages'),
  ('print-jobs',                     1, 'select count(*) as c fromprint_jobs'),
  ('netsuite/sync-runs',             1, 'select count(*) as c fromnetsuite_sync_runs'),
  ('netsuite/retry-queue',           1, 'select count(*) as c fromnetsuite_retry_queue'),
  ('netsuite/open-orders',           1, 'select count(*) as c fromnetsuite_open_orders'),
  ('netsuite/vendors',               1, 'select count(*) as c fromnetsuite_vendors'),
  ('netsuite/purchase-orders',       1, 'select count(*) as c fromnetsuite_purchase_orders'),
  ('sap/sync-runs',                  1, 'select count(*) as c fromsap_sync_runs'),
  ('sap/business-partners',          1, 'select count(*) as c fromsap_business_partners'),
  ('sap/materials',                  1, 'select count(*) as c fromsap_materials'),
  ('tally/companies',                1, 'select count(*) as c fromtally_companies'),
  ('tally/voucher-records',          1, 'select count(*) as c fromtally_voucher_records'),
  ('tally/payment-receipts',         1, 'select count(*) as c fromtally_payment_receipts'),
  ('tally/sync-runs',                1, 'select count(*) as c fromtally_sync_runs')
),
counted as (
